<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucPromenaLozinkeKorisnika.ascx.cs" Inherits="BieEnWeb.UserControls.ucPromenaLozinkeKorisnika" %>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <asp:TextBox ID="tbImePrezime" runat="server" CssClass="glowing-border" Width="225px" Height="24px"></asp:TextBox>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <asp:TextBox ID="tbPocetnaLozinka" CssClass="glowing-border" runat="server" Width="225px" Height="24px"></asp:TextBox>
        </div>
        <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12">
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
            <asp:Button ID="btnPromeniLozinku" runat="server" CssClass="dugme150" Width="225px" Enabled="true" OnClick="btnPromeniLozinku_OnClick" OnClientClick="ClientSideClick(this)" Style="text-align: center; font-size: 14px;" Text="Promeni lozinku" UseSubmitBehavior="false" />
        </div>
    </div>
