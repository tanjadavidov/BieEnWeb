...
{
    public partial class PromenaLozinkeKorisnika : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack && !IsCallback)
            {
                ((Label)Page.Master.FindControl("lblNaslov")).Text = "Provera lozinke korisnika ";
                aaaProvera();
            }
        }
        ...
        protected void aaaProvera()
        {
            ...
            catch (Exception ex)
            {
                ...
                ObradaiObavestenje("Greška u metodi aaaProvera pri pozivu procedure aaaKorisnikPravoNaFunkciju!  \\n\\n" + ex.Message);
                return;
            }
            try
            {
